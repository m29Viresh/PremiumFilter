...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003648125133').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1003702661625')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003830567909')).split()]
...
HOW_TO_DOWNLOAD =  environ.get('HOW_TO_DOWNLOAD', 'https://t.me/+MUo5Ll1XHOUyZWRl')

AUTO_DELETE_SECONDS = int(environ.get('AUTO_DELETE_SECONDS', 100))

FILE_REQ_CHANNEL = int(environ.get('FILE_REQ_CHANNEL', LOG_CHANNEL))

SHORTNER_SITE =  environ.get('SHORTNER_SITE', 'https://arolinks.com') #Put Only Shortner Site domain don't put like this https://tnlink.in/

SHORTNER_API =  environ.get('SHORTNER_API', '4b1f3f4727149030af0795b3c8d03e1e1fa609c6')
